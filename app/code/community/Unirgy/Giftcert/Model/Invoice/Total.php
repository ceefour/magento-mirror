...
class Unirgy_Giftcert_Model_Invoice_Total extends Mage_Sales_Model_Order_Invoice_Total_Abstract
{
    public function collect(Mage_Sales_Model_Order_Invoice $invoice)
    {
        ...
        $baseGcInvoiced = $order->getBaseGiftcertInvoiced();
        $baseInvoiceTotal = $invoice->getBaseGrandTotal();
        $gcAmount = $order->getGiftcertAmount();
        $gcInvoiced = $order->getGiftcertInvoiced();
        ...
        $order->setBaseGiftcertInvoiced($baseGcInvoiced+$baseGcUsed);
        $order->setGiftcertInvoiced($gcInvoiced+$gcUsed);
