 ...
 */
class Intik_Indonesiakurir_Block_Adminhtml_Indonesiakurir_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('indonesiakurirGrid');
      $this->setDefaultSort('indonesiakurir_id');
  ...
  protected function _prepareColumns()
  {
      $this->addColumn('indonesiakurir_id', array(
		...
		$this->addColumn('service_name', array(
          ...
          'width'     => '80px',
          'type'      => 'options',
          'options'   => Mage::getModel('indonesiakurir/servicename')->getOptionArray(),
		));
