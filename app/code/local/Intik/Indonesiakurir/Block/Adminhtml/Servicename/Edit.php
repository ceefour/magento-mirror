 ...
 */
class Intik_Indonesiakurir_Block_Adminhtml_Servicename_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('indonesiakurir')->__('Save Service'));
        $this->_updateButton('delete', 'label', Mage::helper('indonesiakurir')->__('Delete Service'));
    ...
    {	    
        if( Mage::registry('servicename_data') && Mage::registry('servicename_data')->getId() ) {
            ...
            return Mage::helper('indonesiakurir')->__('Add Services');
        }
    }
}